...
def check_key(key, username_trial):
    ...
    if len(key) != len(key_full_template_trial):
        ...
        print('[+] Static key part is valid')
        # TODO : test performance on toolbox container
        # Check dynamic part --v
        # i=8
        # key[9] is sha256(username_trial)[4]
        ...
        # key[10] is sha256(username_trial)[5]
        ...
        # key[11] is sha256(username_trial)[3]
        ...
        # key[12] is sha256(username_trial)[6]
        ...
        # key[13] is sha256(username_trial)[2]
        ...
        # key[14] is sha256(username_trial)[7]
        ...
        # key[15] is sha256(username_trial)[1]
        ...
        # key[16] is sha256(username_trial)[8]
