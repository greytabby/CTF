...
# The input string is xor'd by 8 and the string in the data section is compared, so xor'ing the string in the data section by 8 gives us the flag.
data = 'xakgK\x5cNs((j:l9<mimk?:k;9;8=8?=0?>jnn:j=lu\00\00'
